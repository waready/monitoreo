...
var config = {
  ...
  databaseURL: "https://tesisusers-default-rtdb.firebaseio.com",
...
new Vue({
    ...
    created(){
      ...
      firebase.auth().signInWithEmailAndPassword('quasar@admin.com','123456')
        .then((response)=>{
         
          console.log(response);

          db.ref('/users').on('value', snapshot => this.cargarMensajes(snapshot.val()))
        ...
        cargarMensajes(respuestas){
          ...
          for (let key in respuestas) {
              ...
              this.respuesta.push({
                  ...
                  email: respuestas[key].email,
                  online: respuestas[key].online,
                  time: respuestas[key].update_at,
                  key:key
              });
